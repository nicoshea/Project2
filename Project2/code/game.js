...
var wobbleSpeed = 8, wobbleDist = 0.10;
...
var SSpeed = 15, SDist = 0.15;

Spike.prototype.act = function(step) {
  this.wobble += step * SSpeed;
  var wobblePos = Math.sin(this.wobble) * SDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
//
...
function runAnimation(frameFunc) {
  ...
  function frame(time) {
    ...
    if (lastTime != null) {
      ...
      // having big jumps
      var timeStep = Math.min(time - lastTime, 200) / 1000;
